...
Gem::Specification.new do |s|
  ...
  s.post_install_message = "\nhen-0.8.7 [2016-10-12]:\n\n* Gracefully handle newly initialized repository.\n\n".freeze
  s.rdoc_options = ["--title".freeze, "hen Application documentation (v0.8.7)".freeze, "--charset".freeze, "UTF-8".freeze, "--line-numbers".freeze, "--all".freeze, "--main".freeze, "README".freeze]
