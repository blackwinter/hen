...
Gem::Specification.new do |s|
  ...
  s.post_install_message = "\nhen-0.9.1 [2019-02-02]:\n\n* Added (now missing) +require+.\n\n".freeze
  s.rdoc_options = ["--title".freeze, "hen Application documentation (v0.9.1)".freeze, "--charset".freeze, "UTF-8".freeze, "--line-numbers".freeze, "--all".freeze, "--main".freeze, "README".freeze]
